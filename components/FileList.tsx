...
import FileActionBttons from "./FileActionButtons";
...
export default function FileList({
    ...
    const starredCount = useMemo(() => {
        return files.filter((file) => file.isStarred).length;
    }, [files]);
    ...
    const handleDeleteFile = async (fileId: string) => {
        try {
            ...
            addToast({
                title: "Action Failed",
                description: "We couldn't delete the file status. Please try again.",
                color: "danger",
            });
        }
    };
    ...
    const handleEmptyTrash = async () => {
        try {
            ...
            addToast({
                title: "Action Failed",
                description: "We coudln't empty the trash. Please try again later.",
                color: "danger",
            });
        }
    };
    ...
    const openImageViewer = (file: FileType) => {
        if (file.type.startsWith("image/")) {
            // create a link from imagekit transformations
